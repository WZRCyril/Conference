(function () {
            ...
            var contract = function (module) {
                ...
                Contract._static_methods = {
                    setProvider: function (provider) {
                        ...
                        if (this._json.networks[this.network_id] == null) {
                            this._json.networks[this.network_id] = {events: {}, links: {}}
                        }
                ...
                Contract._properties = {
                    contract_name: {
                        ...
                        get: function () {
                            ...
                            if (this._json.networks[network_id] == null) {
                                this._json.networks[network_id] = {events: {}, links: {}}
                            }
    ...
    }, {"./statuserror.js": 79, "ethjs-abi": 51, "truffle-blockchain-utils": 66, web3: 45}],
    ...
    }, {"./contract.js": 1, "truffle-contract-schema": 67}],
        ...
        module.exports = function (metaSchema, keywordsJsonPointers) {
            for (var i = 0; i < keywordsJsonPointers.length; i++) {
                ...
                for (j = 0; j < KEYWORDS.length; j++) {
                    ...
                    if (schema) {
                        keywords[key] = {anyOf: [schema, {$ref: "https://raw.githubusercontent.com/epoberezkin/ajv/master/lib/refs/$data.json#"}]}
                    }
                }
            }
            return metaSchema
    ...
    4: [function (require, module, exports) {
        "use strict";
        var compileSchema = require("./compile"), resolve = require("./compile/resolve"), Cache = require("./cache"), SchemaObject = require("./compile/schema_obj"), stableStringify = require("fast-json-stable-stringify"), formats = require("./compile/formats"), rules = require("./compile/rules"), $dataMetaSchema = require("./$data"), patternGroups = require("./patternGroups"), util = require("./compile/util"), co = require("co");
        module.exports = Ajv;
    ...
    8: [function (require, module, exports) {
        ...
        module.exports = {Validation: errorSubclass(ValidationError), MissingRef: errorSubclass(MissingRefError)};
    ...
    10: [function (require, module, exports) {
        "use strict";
        var resolve = require("./resolve"), util = require("./util"), errorClasses = require("./error_classes"), stableStringify = require("fast-json-stable-stringify");
    ...
    11: [function (require, module, exports) {
        "use strict";
        var url = require("url"), equal = require("fast-deep-equal"), util = require("./util"), SchemaObject = require("./schema_obj"), traverse = require("json-schema-traverse");
    ...
    }, {"./schema_obj": 13, "./util": 15, "fast-deep-equal": 53, "json-schema-traverse": 58, url: 74}],
    12: [function (require, module, exports) {
        "use strict";
        var ruleModules = require("./_rules"), toHash = require("./util").toHash;
    ...
    }, {"./ucs2length": 14, "fast-deep-equal": 53}],
    ...
    39: [function (require, module, exports) {
        ...
        module.exports = {add: addKeyword, get: getKeyword, remove: removeKeyword};
        ...
        (function (Buffer) {
            ...
            var coderBoolean = {
                encode: function encodeBoolean(value) {
                    ...
                    return {consumed: result.consumed, value: !result.value.isZero()}
                }
            };
            ...
            var coderAddress = {
                encode: function encodeAddress(valueInput) {
                    ...
                    return {consumed: 32, value: "0x" + data.slice(offset + 12, offset + 32).toString("hex")}
                }
            };
            ...
            function coderArray(coder, lengthInput) {
                return {
                    encode: function encodeArray(value) {
                        ...
                        return {consumed: consumed, value: value}
    ...
    }, {"bn.js": 44, buffer: 46, "js-sha3": 57, "number-to-bn": 59}],
    ...
    58: [function (require, module, exports) {
        ...
        traverse.arrayKeywords = {items: true, allOf: true, anyOf: true, oneOf: true};
        traverse.propsKeywords = {definitions: true, properties: true, patternProperties: true, dependencies: true};
    ...
    67: [function (require, module, exports) {
        ...
        var properties = {
            contractName: {sources: ["contractName", "contract_name"]},
            abi: {
                sources: ["abi", "interface"], transform: function (value) {
                    if (typeof value === "string") {
                        try {
            ...
            sourceMap: {sources: ["sourceMap", "srcmap", "evm.bytecode.sourceMap"]},
            deployedSourceMap: {sources: ["deployedSourceMap", "srcmapRuntime", "evm.deployedBytecode.sourceMap"]},
            source: {},
            sourcePath: {},
            ast: {},
            legacyAST: {
            ...
            schemaVersion: {sources: ["schemaVersion", "schema_version"]},
            updatedAt: {
                sources: ["updatedAt", "updated_at"], transform: function (value) {
                    if (typeof value === "number") {
    ...
    68: [function (require, module, exports) {
        module.exports = {
            ...
            author: {name: "Tim Coulter", email: "tim.coulter@consensys.net"},
            bugs: {url: "https://github.com/trufflesuite/truffle-schema/issues"},
            bundleDependencies: false,
            dependencies: {ajv: "^5.1.1", "crypto-js": "^3.1.9-1", debug: "^3.1.0"},
            deprecated: false,
            description: "JSON schema for contract artifacts",
            devDependencies: {mocha: "^3.2.0", solc: "^0.4.16"},
            homepage: "https://github.com/trufflesuite/truffle-schema#readme",
            keywords: ["ethereum", "json", "schema", "contract", "artifacts"],
            license: "MIT",
            main: "index.js",
            name: "truffle-contract-schema",
            repository: {type: "git", url: "git+https://github.com/trufflesuite/truffle-schema.git"},
            scripts: {test: "mocha"},
            version: "2.0.0"
        }
    }, {}],
            ...
            definitions: {
                ...
                NormalFunction: {
                    ...
                    properties: {
                        ...
                        outputs: {type: "array", items: {$ref: "#/definitions/Parameter"}, default: []},
                ...
                Event: {
                    ...
                    properties: {
                        ...
                        name: {$ref: "#/definitions/Name"},
                        inputs: {type: "array", items: {$ref: "#/definitions/EventParameter"}},
                ...
                Parameter: {
                    type: "object",
                    properties: {name: {$ref: "#/definitions/Name"}, type: {$ref: "#/definitions/Type"}},
                    required: ["name", "type"]
                },
                EventParameter: {
                    type: "object",
    ...
    70: [function (require, module, exports) {
        module.exports = {
            ...
            properties: {
                ...
                abi: {allOf: [{$ref: "abi.spec.json#"}, {description: "Interface description returned by compiler for source"}]},
                bytecode: {allOf: [{$ref: "#/definitions/Bytecode"}, {description: "Bytecode sent as contract-creation transaction data, with unresolved link references"}]},
                deployedBytecode: {allOf: [{$ref: "#/definitions/Bytecode"}, {description: "On-chain deployed contract bytecode, with unresolved link references"}]},
                sourceMap: {allOf: [{$ref: "#/definitions/SourceMap"}, {description: "Source mapping for contract-creation transaction data bytecode"}]},
                deployedSourceMap: {allOf: [{$ref: "#/definitions/SourceMap"}, {description: "Source mapping for contract bytecode"}]},
                source: {$ref: "#/definitions/Source"},
                sourcePath: {$ref: "#/definitions/SourcePath"},
                ast: {$ref: "#/definitions/AST"},
                legacyAST: {$ref: "#/definitions/LegacyAST"},
                compiler: {type: "object", properties: {name: {type: "string"}, version: {type: "string"}}},
                networks: {
                    patternProperties: {"^[a-zA-Z0-9]+$": {$ref: "network-object.spec.json#"}},
                    additionalProperties: false
                },
            ...
            required: ["abi"],
            patternProperties: {"^x-": {anyOf: [{type: "string"}, {type: "number"}, {type: "object"}, {type: "array"}]}},
            additionalProperties: false,
            definitions: {
                ContractName: {type: "string", pattern: "^[a-zA-Z_][a-zA-Z0-9_]*$"},
                Bytecode: {type: "string", pattern: "^0x0$|^0x([a-fA-F0-9]{2}|__.{38})+$"},
                Source: {type: "string"},
                SourceMap: {
                    type: "string",
    ...
    71: [function (require, module, exports) {
        module.exports = {
            ...
            properties: {
                ...
                events: {
                    type: "object",
                    patternProperties: {"^0x[a-fA-F0-9]{64}$": {$ref: "abi.spec.json#/definitions/Event"}},
                    additionalProperties: false
                },
                links: {
                    type: "object",
                    patternProperties: {"^[a-zA-Z_][a-zA-Z0-9_]*$": {$ref: "#/definitions/Link"}},
                    additionalProperties: false
                }
            },
            additionalProperties: false,
    ...
    }, {"./util": 75, punycode: 61, querystring: 64}],
    ...
    }, {"./support/isBuffer": 77, _process: 60, inherits: 76}],
    ...
    }, {"truffle-error": 73, util: 78, web3: 45}]
}, {}, [2]);